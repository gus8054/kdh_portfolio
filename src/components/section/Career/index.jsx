      ...
      <div className="container">
        ...
        <article className={styles.career_item}>
          ...
          <div className={styles.column}>
            <h3 className={styles.company_name}>주식회사 티마트</h3>
            <p className={styles.period}>2023.09 - 2024.10</p>
            <blockquote className={styles.main_sentense}>
              모두의 시간을 가치있게, 세상에 없던 시간 거래 플랫폼
            </blockquote>
            <ul className={styles.ul_tags}>
              <li>관리자페이지(Next.js)</li>
              <li>홈페이지(VanillaJS)</li>
              <li>AWS 환경 구축</li>
              <li>MySQL</li>
            </ul>
            <ul className={styles.ul_dev_contents}>
              <li>
              ...
              <li>
                ...
                <p className={styles.dev_body}>
                  기존의 Route 53-S3, Route 53-EC2 로만 구축되어진 AWS 환경을
                  완전히 새로 구축. Route 53, Cloud Front를 사용해 prod, dev,
                  test VPC 망 분리. prod 서버 가용영역 추가. 트래픽에 따른
                  로드벨런싱 및 API 서버 Auto Scaling. 관리자 서버는 회사 IP로만
                  접근하도록 방화벽 구성. 개발자 PC는 회사 밖에서도
                  접속가능하도록 OpenVPC 구성. 비개발자 직원들도 회사밖에서
              ...
              <li>
                ...
                <p className={styles.dev_body}>
                  서비스 특성상 개인정보(민감정보 + 위치정보)를 수집하여야
                  하는데 이 경우 상위기관에 정기보고를 해야함. 관리자 페이지
                  개발을 담당하였기에 대응 또한 담당.
                </p>
              </li>
            </ul>
        ...
        <article className={styles.career_item}>
          ...
          <div className={styles.column}>
            <h3 className={styles.company_name}>주식회사 비트시스</h3>
            <p className={styles.period}>2020.12 - 2021.05</p>
            <blockquote className={styles.main_sentense}>
              주식회사 비트시스는 4차산업혁명의 핵심 키워드인 클라우드, AI,
              빅데이터, IOT, 블록체인 분야의 소프트웨어 개발과 교육 & 컨퍼런스
              전문 기업입니다.
            </blockquote>
            <ul className={styles.ul_tags}>
              <li>웹 크롤링</li>
